...
dependencies {
    ...
    // Wear OS & Health
    // ENGINEER NOTE: I removed 'wearable.framework'.
    // If this is a PHONE app, 'wearable.framework' will crash it.
    // Only use 'wearable.framework' in a separate "watch" module.
